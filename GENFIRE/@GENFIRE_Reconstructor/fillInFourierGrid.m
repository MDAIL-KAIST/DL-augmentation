...
%% generalizing a rotation matrix (edited by J.Lee) 
...
rotmat1 = MatrixQuaternionRot(obj.vector1,phi);
rotmat2 = MatrixQuaternionRot(obj.vector2,theta);   
rotmat3 = MatrixQuaternionRot(obj.vector3,psi);
