...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% GENFIRE.filename_Projections = './data/Proj_FePt64_test.mat';
% GENFIRE.filename_Angles = './data/Angles_FePt64_test.mat';
...
filename_Projections = './data/Proj_FePt64_test.mat';
filename_Angles = './data/Angles_FePt64_test.mat';
filename_Support = './data/Emptysupport.mat'; 
% filename_InitialModel = '';
filename_Results = sprintf('./results/GENFIRE_rec_old_%d_%d_%d_%d_%d.mat',A,Pos,Sup,Moddd,Gridd);

numIterations = 50; 
pixelSize = .5; 
oversamplingRatio =3;
griddingMethod = Gridd; 
allowMultipleGridMatches = 1;
constraintEnforcementMode = Moddd; 
interpolationCutoffDistance =Aar(A); 
constraintPositivity = Pos;
constraintSupport = Sup;
ComputeFourierShellCorrelation = 0; 
numBins = 50;
percentValuesForRfree = 0.00;
numBinsRfree = 35;
doCTFcorrection = 0;
