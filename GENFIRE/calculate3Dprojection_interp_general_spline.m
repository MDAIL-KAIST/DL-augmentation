...
function [projection, kSlice] = calculate3Dprojection_interp_general_spline(modelK,phi,theta,psi,vec1,vec2,vec3)
...
kSlice = interp3(ky,kx,kz,modelK,rotKy,rotKx,rotKz,'spline');
