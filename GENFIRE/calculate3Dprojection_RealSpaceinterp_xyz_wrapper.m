function Proj = calculate3Dprojection_RealSpaceinterp_xyz_wrapper(obj, phi, theta, psi)

    Vol = obj.REFINER.refineModel;
    Proj =  calculate3Dprojection_RealSpaceinterp_xyz(Vol,phi,theta,psi);
