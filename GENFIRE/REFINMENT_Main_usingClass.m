...
tomo_angles     = 0:10:180; % true tilt angles
...
num_refinements = 3; % number of refinement loops
...
%%
for i=2:4
  plot(squeeze(REFINEMENT.AngleEvolution(:,2,i) -REFINEMENT.AngleEvolution(:,2,2) ));hold all
  pause
end
